...
KatanA ecosystemでは、KMM、preview、editor、export、widgetが別repositoryへ分離される。各repositoryでAST lintを独自に持つと、ルール、違反形式、実行入口がずれて品質統制が効かなくなる。
